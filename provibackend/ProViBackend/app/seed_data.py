...
CANONICAL_TASKS = [
    {
        "task_key": "task06",
        "label": "What is the overall degree of conformance between the given event log and the guidelines?",
        "description": "Assess the overall conformance rate of the entire event log against the process model.",
        "answer_type": "numeric",
    },
    {
        "task_key": "task28",
        "label": "Where exactly does the process execution differ from the guideline? What does alternative behavior look like?",
    ...
    {
        "task_key": "task20",
        "label": "What control-flow, data, resource, or time attributes of events, traces, or logs lead to guideline violations?",
        "description": "Identify potential root causes of non-conformance.",
        "answer_type": "single_choice",
    },
    {
        "task_key": "task13",
        "label": "What are the underlying reasons for guideline violations?",
    ...
    {
        "task_key": "task21",
        "label": "What are the underlying reasons for guideline violations of traces?",
    ...
    {
        "task_key": "task09",
        "label": "How exactly does the process execution differ from the guidelines? What behavior was prescribed by the guidelines and what behavior was executed instead?",
        "description": "Identify guideline violations per activity and violation type across the entire event log.",
        "answer_type": "multiple_choice",
    },
    {
        "task_key": "task11",
        "label": "How do the guideline violations for the designated activity compare to those of other activities?",
        "description": "Summarize trace-level frequency of predefined guideline violations across the entire event log.",
        "answer_type": "pct-set",
    },
    {
        "task_key": "task12",
        "label": "In what percentage of traces do designated violations occur?",
        "description": "Summarize the proportion of conformant vs deviating traces across the entire event log.",
        "answer_type": "numeric",
    },
    {
        "task_key": "task14",
        "label": "What kind of violation occurs in a given trace, in terms of activity and move types?",
    ...
    {
        "task_key": "task37",
        "label": "How do fitness values of traces differ when applying two different techniques to compute them?",
        "description": "Compare alignment-based and token-based replay fitness per trace; visualize distribution, agreement, and trend.",
        "answer_type": "single_choice",
    },
    {
        "task_key": "task36",
        "label": "Which guideline violations are predominant in my process?",
    ...
    {
        "task_key": "task01",
        "label": "How does the conformance of traces with a certain condition differ from those who do not?",
    ...
    {
        "task_key": "task05",
        "label": "How often does a set of violations occur in different logs?",
        "description": "Track the occurrence frequency of predefined violation patterns across multiple process executions.",
        "answer_type": "multiple_choice",
    },
    {
        "task_key": "task23",
        "label": "How are the guideline violations different to each other?",
        "description": "Summarize and compare violations to understand their variety and relative prevalence.",
        "answer_type": "single_choice",
    },
    {
        "task_key": "task24",
        "label": "Where is the discovered model different to the process model with the desired behavior?",
    ...
    {
        "task_key": "task27",
        "label": "How do conformant and non-conformant traces differ from each other?",
    ...
    {
        "task_key": "task32",
        "label": "What are the main violations in my process and do they differ in between different sub-processes?",
    ...
    {
        "task_key": "task33",
        "label": "How does the overall degree of conformance with a set of guidelines differ between traces with a certain data attribute value?",
    ...
    {
        "task_key": "task34",
        "label": "Where does the recorded behavior violate which guidelines?",
