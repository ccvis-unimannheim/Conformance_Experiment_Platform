...
const TERM_DEFS = {
  ...
  guideline_violation:  { label: "Guideline Violation",             def: "A trace has a guideline violation if its alignment contains a log move or a model move — i.e. any move other than a synchronous move." },
