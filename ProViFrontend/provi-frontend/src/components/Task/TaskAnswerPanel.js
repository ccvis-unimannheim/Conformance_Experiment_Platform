...
const TERM_DEFS = {
  ...
  degree_of_conformance:{ label: "Degree of Conformance (Fitness)", def: "Degree of conformance is the general concept; fitness is its computed value (0–1) measuring how well the event log matches the guideline. Note: NOT the same as conformance rate — fitness accounts for the extent of violations, not just whether a trace is fully conformant." },
